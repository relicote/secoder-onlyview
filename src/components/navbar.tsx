    ...
    <div className="container mx-auto flex h-[91px] w-full max-w-[1920] items-center justify-around gap-2 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-end gap-4">
        <Link href="#" aria-label="Facebook">
            <div className="p-0 h-5 w-5 text-foreground/80 hover:text-primary transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" color="#D3DFFF"  viewBox="0 0 16 16">
        ...
        <Link href="#" aria-label="Instagram">
            <div className="p-0 h-5 w-5 text-foreground/80 hover:text-primary transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" color="#1A5CFF"  viewBox="0 0 16 16">
        ...
        <Link href="#" aria-label="TikTok">
            <Image
                src={tikTokIcon}
                alt="TikTok Icon"
                className="h-5 w-5 text-foreground/80 hover:text-primary transition-colors"
                data-ai-hint="TikTok"
            />
        </Link>
        <Link href="#" aria-label="TikTok">
            <div className="h-5 w-5 text-foreground/80 hover:text-primary transition-colors bg-[#D3DFFF] [mask:url(../images/twitter-x.svg)_no-repeat_center] [mask-size:contain]" />
        </Link>
      </div>
    </div>
  </header>
